...
const pages = [
  ...
  { href: "/configuration?tab=brands", title: "Configuration · Brands" },
  { href: "/configuration?tab=panel", title: "Configuration · Panel" },
  { href: "/configuration?tab=expenses", title: "Configuration · Expenses" },
  { href: "/configuration?tab=subscriptions", title: "Configuration · Subscriptions" },
